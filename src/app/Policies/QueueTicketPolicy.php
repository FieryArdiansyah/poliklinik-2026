...
class QueueTicketPolicy
{
    ...
    {
        return $user->can('view_any_queue::ticket');
    }
    ...
    {
        return $user->can('view_queue::ticket');
    }
    ...
    {
        return $user->can('create_queue::ticket');
    }
    ...
    {
        return $user->can('update_queue::ticket');
    }
    ...
    {
        return $user->can('delete_queue::ticket');
    }
    ...
    {
        return $user->can('delete_any_queue::ticket');
    }
     ...
     */
    public function replicate(User $user, QueueTicket $queueTicket): bool
    {
